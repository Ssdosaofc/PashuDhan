                  ...
                  child: BlocBuilder<AnimalBloc, AnimalState>(
                    builder: (context, state) {
                      ...
                      return Row(
                        ...
                        children: [
                          _statCard("Total Cases", '4', Icons.history, Colors.teal),
                          _statCard("This Month", '4', Icons.calendar_today, Colors.orange),
                          _statCard("Follow-ups", "1", Icons.watch_later_outlined, Colors.green),
                        ],
                      );
                    },
                  ),
